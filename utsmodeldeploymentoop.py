...
class ModelXGB:
    #inisiasi model dan membaca data
    ...
    #memperbaiki kolom person gender
    ...
    #function untuk export fitur-fitur nama tiap kolumn 
    def export_feature_names(self, filename):
        with open(filename, 'wb') as f:
            pkl.dump(self.feature_names, f)
    #function untuk melakukan preprocesing encode dan scaling
    ...
    #function evaluasi menggunakan clasification report 
    ...
    def test(self):
        ...
        self.evaluate(pred)
    #function untuk export model menggunakan pickel 
    def export_model(self, filename):
        if self.fitted_model is None:
            raise ValueError("No Model Found!")
        with open(filename, 'wb') as file:
            pkl.dump(self.fitted_model, file)
    #function untuk export scaling menggunakan pickel 
    def export_scaler(self, filename):
        with open(filename, 'wb') as file:
            pkl.dump(self.scaler, file)
    #function untuk export encoding menggunakan pickel
    def export_encoder(self, filename):
        with open(filename, 'wb') as file:
            pkl.dump(self.encoder, file)
    #function untuk export target value menggunakan pickel
    def export_target_vals(self, filename):
        with open(filename, 'wb') as file:
            pkl.dump(self.target_vals, file)
    #function untuk predict input 
